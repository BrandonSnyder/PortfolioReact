    ...
    return(
        <section id="aboutmeContainer">
            <div className='leftAboutMe'>
                ...
                <a href='mailto:Brandon.Snyder019@gmail.com? subject=Good Afternoon'> <BsFillEnvelopeFill/></a>
                <a href='https://www.linkedin.com/in/brandonlsnyder/'> <BsLinkedin/></a>
                <a href='https://github.com/BrandonSnyder'> <BsGithub/></a>
                </div>
            </div>
            <div className='rightAboutMe'>
              ...
              <div className='resumeContainer'>
                <a href="https://drive.google.com/file/d/1QAFS0f-T2aaitTer9OvhbnafRQpQAeCN/view?usp=sharing" download>Click to Download Resume</a>  
              </div>
            </div>
